...
def update_value_by_id(db_name: str, collection: str, obj_name: str, id: int, value: Any) -> None:
    """
    Objective:
    The objective of the function is to update a single value in a specific object of a collection in a given self,
...
def update_values_by_id(db_name: str, collection: str, obj_name: str, id: list, values: list) -> None:
    """
    Objective:
    The objective of the function is to update multiple values in a specific object of a collection in a given self,
    ...
    Flow:
        ...
        - For each identifier, the function calls the _get_value_index() function to retrieve the index of the value in
          the specified object of the specified collection in the specified self, based on the provided identifier.
    ...
    Additional aspects:
        - The function assumes that the self, collection, object, and values with the provided names and identifiers
          exist.
    ...
    for i, id in enumerate(id):
        ...
        if index is None:
            raise ValueError(f'Value with id {id} not found in self')
